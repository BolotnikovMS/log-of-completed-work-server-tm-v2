...
export const numberCheck = vine.number({ strict: true }).positive().withoutDecimals()
export const numberOptional = vine.number({ strict: true }).positive().withoutDecimals().optional().nullable()
