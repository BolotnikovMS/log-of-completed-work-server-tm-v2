...
export const text700Optional = vine.string().trim().minLength(3).maxLength(700).optional()
...
export const numberOptional = vine.number().optional()
...
export const ipOptional = vine.string().ipAddress(4).optional()
